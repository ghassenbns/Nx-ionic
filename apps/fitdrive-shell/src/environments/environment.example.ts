export const environment = {
  production: false,
  config: {
    apiUrl: 'https://dev.advanticsys.net:9443/concordia/api',
  },
  authCodeFlowConfig: {
    grantType: 'password',
    // tokenEndpoint: 'http://localhost/concordia2_api/public/oauth/token',
    tokenEndpoint: 'https://dev.advanticsys.net:9443/auth/token',
    // logoutEndpoint: 'http://localhost/concordia2_api/public/oauth/logout',
    logoutEndpoint: 'https://dev.advanticsys.net:9443/auth/logout',
    // logoutUrl: 'http://localhost/concordia2_api/public/oauth/token',
  ...
  customerName: 'FitDrive',
  customerUrl: 'https://fitdrive.advanticsys.net/',
  loginPageSlider: false,
  logoFormat: 'svg',
  landingLogoFormat: 'svg',
